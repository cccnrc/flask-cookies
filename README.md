...
You can also have a look at a live example o the banner [here](https://olive-carole-69.tiiny.site)
PLease note: as we collapsed the whole thing in a single HTML document for this [live example](https://olive-carole-69.tiiny.site), * *in some browser it might have some rendering problem* *. It should work on Firefox, Safari, Chrome, etc.
